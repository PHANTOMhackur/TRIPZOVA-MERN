...
export default function PartnerReviewsPage() {
  usePageTitle("Reviews | TRIPZOVA Partner");
  useLegacyPage({ styles: ["https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css", "https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css", "/legacy/partner/css/partner.css"], scripts: ["https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js", "/legacy/partner/js/partner.js"], beforeLoad: undefined });
      ...
      <div className={"partner-content"}>
        ...
        <div className={"partner-page-header"}>
          <div>
            ...
            <p>
              See what customers are saying about your rides.
            </p>
          </div>
        </div>
        <div className={"partner-card"}>
          <div className={"partner-empty-state"}>
            ...
            <p>
              Customer reviews and ratings aren't collected on
                        TRIPZOVA yet. Once that feature ships, you'll see
                        every review for your vehicles right here.
            </p>
          </div>
        </div>
      </div>
