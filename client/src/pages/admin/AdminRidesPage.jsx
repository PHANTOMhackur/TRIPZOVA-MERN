...
export default function AdminRidesPage() {
  usePageTitle("Rides | TRIPZOVA Admin");
  useLegacyPage({ styles: ["https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css", "https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css", "/legacy/admin/css/admin.css"], scripts: ["https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js", "/legacy/admin/js/admin.js", "/legacy/admin/js/rides.js"], beforeLoad: undefined });
    ...
    <div className={"admin-layout"}>
      <aside className={"admin-sidebar"} id={"adminSidebar"}>
        ...
        <div className={"sidebar-content"}>
          ...
          <a href={"/admin/rides"} className={"sidebar-link active"}>
            <i className={"bi bi-car-front-fill"}></i>
            <span>
              Rides
            </span>
        ...
        <div className={"admin-content"}>
          <div className={"page-heading-row"}>
            <div>
              ...
              <p>
                All bookings made for point-to-point rides.
              </p>
            </div>
            <button type={"button"} className={"admin-primary-btn"} id={"refreshRidesBtn"}>
          ...
          <div className={"admin-card"}>
            <div className={"admin-card-header partner-toolbar"}>
              <div>
                ...
                <p>
                  Every ride booking across all partners.
                </p>
              </div>
              <div className={"partner-toolbar-controls"}>
                ...
                <select id={"rideStatusFilter"} className={"partner-filter"}>
                  <option value={""}>
                    All Status
                  </option>
            ...
            <div id={"ridesLoading"} className={"admin-loading"}>
              <div className={"spinner-border"} role={"status"}></div>
              <span>
                Loading rides...
              </span>
            </div>
            <div id={"ridesError"} className={"admin-error"} style={{display: "none"}}></div>
            <div className={"table-responsive"} id={"ridesTableContainer"}>
            ...
            <div id={"ridesEmpty"} className={"admin-empty"} style={{display: "none"}}>
              ...
              <p>
                No ride bookings match the current filters.
              </p>
            </div>
          </div>
        </div>
